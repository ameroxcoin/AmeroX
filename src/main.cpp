...
const string strMessageMagic = "AmeroX Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    else if (pindexBest->nHeight+1 <= 2100)
    {
      nSubsidy = 0 * COIN;
      return nSubsidy + nFees;
    }
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "AmeroX", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Wed, 28 Oct 2015 16:43:03 GMT";
        CTransaction txNew;
        txNew.nTime = 1446050583;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1446050585;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1275050;
		if(fTestNet)
        {
            block.nNonce   = 1275050;
        }
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xabd780142b17512d2775ad23c453fba4ad5b1d5b4a508a381d2a5fb513289c06"));
        block.print();
